...
```{r}
ggplot() +
  geom_line(mapping = aes(x = 1:3, y = pk_probs[,"futility_null"], color = "Pocock")) +
  geom_line(mapping = aes(x = 1:3, y = ob_probs[,"futility_null"], color = "O'Brien-Fleming")) +
  geom_line(mapping = aes(x = 1:3, y = tr_probs[,"futility_null"], color = "Triangular")) +
  scale_color_manual(name = "Boundary types",
                     breaks = c("Pocock", "O'Brien-Fleming", "Triangular"),
                     values = c("Pocock" = "red", 
                                "O'Brien-Fleming" = "blue", 
...
```{r}
ggplot() +
  geom_line(mapping = aes(x = 1:3, y = pk_probs[,"efficacy_null"], color = "Pocock")) +
  geom_line(mapping = aes(x = 1:3, y = ob_probs[,"efficacy_null"], color = "O'Brien-Fleming")) +
  geom_line(mapping = aes(x = 1:3, y = tr_probs[,"efficacy_null"], color = "Triangular")) +
  scale_color_manual(name = "Boundary types",
                     breaks = c("Pocock", "O'Brien-Fleming", "Triangular"),
                     values = c("Pocock" = "red", 
                                "O'Brien-Fleming" = "blue", 
...
```{r}
ggplot() +
  geom_line(mapping = aes(x = 1:3, y = pk_probs[,"futility_alt"], color = "Pocock")) +
  geom_line(mapping = aes(x = 1:3, y = ob_probs[,"futility_alt"], color = "O'Brien-Fleming")) +
  geom_line(mapping = aes(x = 1:3, y = tr_probs[,"futility_alt"], color = "Triangular")) +
  scale_color_manual(name = "Boundary types",
                     breaks = c("Pocock", "O'Brien-Fleming", "Triangular"),
                     values = c("Pocock" = "red", 
                                "O'Brien-Fleming" = "blue", 
...
```{r}
ggplot() +
  geom_line(mapping = aes(x = 1:3, y = pk_probs[,"efficacy_alt"], color = "Pocock")) +
  geom_line(mapping = aes(x = 1:3, y = ob_probs[,"efficacy_alt"], color = "O'Brien-Fleming")) +
  geom_line(mapping = aes(x = 1:3, y = tr_probs[,"efficacy_alt"], color = "Triangular")) +
  scale_color_manual(name = "Boundary types",
                     breaks = c("Pocock", "O'Brien-Fleming", "Triangular"),
                     values = c("Pocock" = "red", 
                                "O'Brien-Fleming" = "blue", 
